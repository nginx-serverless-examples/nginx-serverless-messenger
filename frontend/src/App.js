...
const API_GATEWAY_ID = "bxm5rzwd0a"
const SOCKET_API_GATEWAY_ID = "dngxzf7nnc"
class App extends Component {
  ...
  connectToWebScoket = () => {
    const address = `wss://${SOCKET_API_GATEWAY_ID}.execute-api.us-east-2.amazonaws.com/dev?user_id=test&room_id=test`
